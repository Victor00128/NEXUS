...
#
# Build:  docker build -t nexus-api .
# Run:    docker run -p 7860:7860 \
#           -e OPENROUTER_API_KEY=sk-or-... \
#           -e NEXUS_API_KEY=your-secret-key \
#           nexus-api
#
# OPENROUTER_API_KEY: Your OpenRouter key (powers all model calls)
# NEXUS_API_KEY:    Auth key callers must send as Bearer token
# HF_TOKEN:           HuggingFace write token for auto-publishing data
# HF_DATASET_REPO:    Target HF dataset repo (e.g. LYS10S/nexus-research)
