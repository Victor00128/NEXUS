 ...
 *
 * Reads published batch files back from the nexuslabs/NEXUS
 * HuggingFace Dataset repo. Complements data-publisher.ts (write) with
...
function getConfig() {
  return {
    ...
    repo: process.env.DATA_REPO || 'nexuslabs/NEXUS',
...
export { flushMetadata, flushDataset } from './data-publisher'
