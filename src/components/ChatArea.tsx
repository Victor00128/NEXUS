...
export function ChatArea() {
  const {
    ...
    dynamicUpgradeEnabled, setDynamicUpgradeEnabled,
    promptsTried,
    raceEnabled, synthesisEnabled,
  } = useStore()
    ...
    <div className="flex flex-col h-screen relative">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-theme-primary bg-theme-dim/50">
        ...
        <div className="flex items-center gap-3 text-xs theme-secondary">
          ...
          {/* Dynamic Upgrade universal toggle */}
          <button
            onClick={() => setDynamicUpgradeEnabled(!dynamicUpgradeEnabled)}
            ...
            title={dynamicUpgradeEnabled
              ? 'Dynamic Upgrade ON — responses morph live as better answers arrive'
              : 'Dynamic Upgrade OFF — wait for final response'
            }
          >
