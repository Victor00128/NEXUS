 ...
 */
export const hedgeReducer: TransformModule = {
  id: 'hedge_reducer',
  name: 'Hedge Reducer',
 ...
 */
export const directMode: TransformModule = {
  id: 'direct_mode',
  name: 'Direct Mode',
 ...
 */
export const casualMode: TransformModule = {
  id: 'casual_mode',
  name: 'Casual Mode',
 ...
 * Export all modules
 */
export const allModules: TransformModule[] = [
  hedgeReducer,
  directMode,
  casualMode
]
