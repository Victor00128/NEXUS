 ...
 * a harm category. Runs alongside TUNING — same pattern, zero API cost.
 *
...
const RULES: PatternRule[] = [
  ...
  // Malware
  {
    domain: 'electric', sub: 'malware', weight: 10,
    patterns: [
  ...
  // Exploits
  {
    domain: 'electric', sub: 'exploit', weight: 10,
    patterns: [
  ...
  // Intrusion / hacking
  {
    domain: 'electric', sub: 'intrusion', weight: 8,
    patterns: [
  ...
  // Phishing
  {
    domain: 'electric', sub: 'phishing', weight: 8,
    patterns: [
  ...
  // Credential attacks
  {
    domain: 'electric', sub: 'credential', weight: 7,
    patterns: [
  ...
  // DDoS
  {
    domain: 'electric', sub: 'ddos', weight: 8,
    patterns: [
  ...
  {
    domain: 'electric', sub: 'spyware', weight: 8,
    patterns: [
 ...
 */
export function categorizePrompt(prompt: string): ClassificationResult {
