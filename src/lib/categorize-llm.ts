...
import type { HarmDomain, HarmSubcategory, ClassificationResult, PromptIntent } from './categorize'
import { categorizePrompt as classifyRegex } from './categorize'
...
const VALID_DOMAINS = new Set<HarmDomain>([
  'violence', 'self_harm', 'sexual', 'hate', 'cbrn', 'electric', 'fraud',
