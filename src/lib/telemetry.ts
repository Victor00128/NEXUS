...
export interface ChatTelemetryData {
  ...
  // tuning metadata (context detection only)
  tuning?: {
  ...
  obfuscation_transformed?: boolean // did obfuscation actually transform the prompt
}
 ...
 * Call this after every LLM request (both standard and RACE).
 */
