/**
 * OBFUSCATION - Input Obfuscation Engine
...
export interface ObfuscationResult {
  ...
  techniqueUsed: ObfuscationMethod
...
/**
 * Main OBFUSCATION transformation function
 * Detects trigger words and obfuscates them
 */
export function encodeObfuscation(
  text: string,
  ...
  const triggersFound = detectObfuscation(text, config.customTriggers)
  ...
  const transformations: ObfuscationResult['transformations'] = []
...
/**
 * Get the default OBFUSCATION config
 */
 ...
 */
export function getTechniqueDescription(technique: ObfuscationMethod): string {
  const descriptions: Record<ObfuscationMethod, string> = {
